...
/**  Function to fetch the ajax data of ShopForce **/


    public function shopforceget(Request $request)
    {
$business_id = $request->session()->get('user.business_id');
$BusinessLocation =11;
$veriation= VariationLocationDetails::where('location_id','=',11)->get();
return view('report.test')
            ->with(compact('veriation'));
    ...
    public function getStockReport(Request $request)
    {
        ...
        $units = Unit::where('business_id', $business_id)
                            ->pluck('short_name', 'id');
        $business_locations = BusinessLocation::forDropdown($business_id, true);
if(session()->get('user.business_id')!=7)
{
...
$business= BusinessLocation::where('business_id','=',$business_id)->get();

return view('report.stock_report1')
            ->with(compact('categories', 'brands', 'units', 'business_locations', 'show_manufacturing_data','business'));
 }
