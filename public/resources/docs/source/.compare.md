...
[Get Postman Collection](https://erp.dstadvertising.com/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://erp.dstadvertising.com/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"esse","ip_address":"corrupti","latitude":"distinctio","longitude":"quis"}'
...
```bash
curl -X POST \
    "https://erp.dstadvertising.com/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"maxime","latitude":"ea","longitude":"cumque"}'
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/holidays?location_id=velit&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=optio&follow_up_type=eius&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"quis","schedule_type":"error","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=iure&biz_name=delectus&mobile_num=8&contact_id=itaque&order_by=rerum&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://erp.dstadvertising.com/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"perspiciatis","mobile_name":"odit","call_type":"call","start_time":"asperiores","end_time":"sit","duration":"aspernatur"}]}'
...
let body = {
    "call_logs": [
        {
            "mobile_number": "perspiciatis",
            "mobile_name": "odit",
            "call_type": "call",
            "start_time": "asperiores",
            "end_time": "sit",
            "duration": "aspernatur"
        }
    ]
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=aut&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":4,"initial_amount":326841,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":22581526.272371001541614532470703125,"total_card_slips":5,"total_cheques":17,"closing_note":"et","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 4,
    "initial_amount": 326841,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 22581526.272371001541614532470703125,
    "total_card_slips": 5,
    "total_cheques": 17,
    "closing_note": "et",
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/contactapi?type=maxime&name=voluptatem&biz_name=autem&mobile_num=18&contact_id=vel&order_by=quos&direction=quam&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"aut","prefix":"nulla","first_name":"voluptatibus","middle_name":"eveniet","last_name":"hic","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"non","address_line_2":"voluptatem","city":"in","state":"omnis","country":"officia","zip_code":"voluptas","customer_group_id":"dolorem","contact_id":"sit","dob":"2000-06-13","custom_field1":"et","custom_field2":"eos","custom_field3":"recusandae","custom_field4":"consequatur","email":"necessitatibus","shipping_address":"ut","position":"sed","opening_balance":0,"source_id":17,"life_stage_id":12,"assigned_to":[]}'
...
let body = {
    ...
    "country": "officia",
    "zip_code": "voluptas",
    "customer_group_id": "dolorem",
    "contact_id": "sit",
    "dob": "2000-06-13",
    "custom_field1": "et",
    "custom_field2": "eos",
    "custom_field3": "recusandae",
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"dolorem","prefix":"explicabo","first_name":"minima","middle_name":"amet","last_name":"distinctio","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"soluta","address_line_2":"hic","city":"cupiditate","state":"quo","country":"ad","zip_code":"aliquam","customer_group_id":"in","contact_id":"et","dob":"2000-06-13","custom_field1":"dolor","custom_field2":"et","custom_field3":"nihil","custom_field4":"id","email":"id","shipping_address":"nesciunt","position":"vero","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":15,"life_stage_id":15,"assigned_to":[]}'
...
```bash
curl -X POST \
    "https://erp.dstadvertising.com/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":5,"card_number":"vero","card_holder_name":"sed","card_transaction_number":"sed","card_type":"excepturi","card_month":"labore","card_year":"sed","card_security":"a","transaction_no_1":"qui","transaction_no_2":"aperiam","transaction_no_3":"dolorem","cheque_number":"facere","bank_account_number":"ex","note":"laboriosam"}'
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/expense?location_id=laudantium&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=labore&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/expense"
);

let params = {
    "location_id": "laudantium",
    "payment_status": "paid",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "expense_for": "labore",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":16,"final_total":19101,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":5,"expense_for":19,"contact_id":19,"additional_notes":"sapiente","is_refund":0,"is_recurring":0,"recur_interval":5,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"iste","recur_repetitions":9,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":11,"card_number":"quia","card_holder_name":"quia","card_transaction_number":"vero","card_type":"atque","card_month":"natus","card_year":"soluta","card_security":"quia","transaction_no_1":"deleniti","transaction_no_2":"culpa","transaction_no_3":"dicta","note":"expedita","cheque_number":"odio"}]}'
    ...
    "payment": [
        {
            ...
            "card_transaction_number": "vero",
            "card_type": "atque",
            "card_month": "natus",
            "card_year": "soluta",
            "card_security": "quia",
            "transaction_no_1": "deleniti",
            "transaction_no_2": "culpa",
            "transaction_no_3": "dicta",
            "note": "expedita",
            "cheque_number": "odio"
        }
    ]
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://erp.dstadvertising.com/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":238805.31047629998647607862949371337890625,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":16,"expense_for":17,"contact_id":19,"additional_notes":"qui","is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"praesentium","recur_repetitions":4,"payment":[]}'
...
let body = {
    "final_total": 238805.31047629998647607862949371337890625,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 16,
    "expense_for": 17,
    "contact_id": 19,
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/expense-refund?location_id=laborum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=quia&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/product?brand_id=sapiente&category_id=numquam&sub_category_id=adipisci&location_id=consequatur&selling_price_group=sapiente&name=quasi&sku=aut&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/product/1?selling_price_group=veniam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "veniam",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/variation/?brand_id=qui&category_id=consectetur&sub_category_id=rerum&not_for_selling=quod&name=eum&sku=adipisci&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/sell?location_id=harum&contact_id=aut&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=praesentium&service_staff_id=sunt&shipping_status=ordered&only_subscriptions=voluptatem&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "praesentium",
    "service_staff_id": "sunt",
    "shipping_status": "ordered",
    "only_subscriptions": "voluptatem",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":18,"contact_id":13,"transaction_date":"2020-07-22 15:48:29","invoice_no":"labore","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":8,"discount_amount":10,"discount_type":"fixed","sale_note":"est","staff_note":"tempore","commission_agent":1,"shipping_details":"Express Delivery","shipping_address":"dolores","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":7,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"nobis","recur_repetitions":4,"rp_redeemed":12,"rp_redeemed_amount":13.5,"types_of_service_id":10,"service_custom_field_1":"vel","service_custom_field_2":"consequatur","service_custom_field_3":"ipsa","service_custom_field_4":"voluptas","round_off_amount":2.673013759999999905403456068597733974456787109375,"table_id":5,"service_staff_id":5,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":15,"note":"et"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":20,"card_number":"dignissimos","card_holder_name":"et","card_transaction_number":"pariatur","card_type":"esse","card_month":"ipsam","card_year":"aut","card_security":"qui","transaction_no_1":"placeat","transaction_no_2":"expedita","transaction_no_3":"velit","bank_account_number":"voluptatum","note":"omnis","cheque_number":"quisquam"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "vel",
            "service_custom_field_2": "consequatur",
            "service_custom_field_3": "ipsa",
            "service_custom_field_4": "voluptas",
            "round_off_amount": 2.673013759999999905403456068597733974456787109375,
            "table_id": 5,
            "service_staff_id": 5,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "method": "cash",
                    "account_id": 20,
                    "card_number": "dignissimos",
                    "card_holder_name": "et",
                    "card_transaction_number": "pariatur",
                    "card_type": "esse",
                    "card_month": "ipsam",
                    "card_year": "aut",
                    "card_security": "qui",
                    "transaction_no_1": "placeat",
                    "transaction_no_2": "expedita",
                    "transaction_no_3": "velit",
                    "bank_account_number": "voluptatum",
                    "note": "omnis",
                    "cheque_number": "quisquam"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://erp.dstadvertising.com/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":15,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":14,"discount_amount":10,"discount_type":"fixed","sale_note":"qui","staff_note":"iure","sells":[{"is_suspend":false}],"commission_agent":5,"shipping_details":"Express Delivery","shipping_address":"molestiae","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":10,"pay_term_number":9,"pay_term_type":"months","is_recurring":0,"recur_interval":19,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"ad","recur_repetitions":5,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":14,"service_custom_field_1":"ut","service_custom_field_2":"reiciendis","service_custom_field_3":"dignissimos","service_custom_field_4":"molestiae","round_off_amount":12852.373900000000503496266901493072509765625,"table_id":18,"service_staff_id":4,"change_return":0,"change_return_id":8,"products":[{"sell_line_id":13,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":15,"discount_amount":0,"discount_type":"percentage","sub_unit_id":19,"note":"facere"}],"payments":[{"payment_id":1,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":18,"card_number":"labore","card_holder_name":"qui","card_transaction_number":"ea","card_type":"quos","card_month":"occaecati","card_year":"veritatis","card_security":"non","transaction_no_1":"quis","transaction_no_2":"qui","transaction_no_3":"recusandae","note":"qui","cheque_number":"deleniti","bank_account_number":"error"}]}'
...
let body = {
    ...
    "service_custom_field_2": "reiciendis",
    "service_custom_field_3": "dignissimos",
    "service_custom_field_4": "molestiae",
    "round_off_amount": 12852.373900000000503496266901493072509765625,
    "table_id": 18,
    "service_staff_id": 4,
    "change_return": 0,
    "change_return_id": 8,
    ...
    "payments": [
        {
            ...
            "card_type": "quos",
            "card_month": "occaecati",
            "card_year": "veritatis",
            "card_security": "non",
            "transaction_no_1": "quis",
            "transaction_no_2": "qui",
            "transaction_no_3": "recusandae",
            "note": "qui",
            "cheque_number": "deleniti",
...
```bash
curl -X DELETE \
    "https://erp.dstadvertising.com/public/connector/api/sell/in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://erp.dstadvertising.com/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":9,"transaction_date":"2020-5-7 15:20:22","invoice_no":"officia","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":14,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://erp.dstadvertising.com/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":7,"shipping_status":"ordered","delivered_to":"est"}'
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/table?location_id=rerum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/taxonomy?type=aperiam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/user?service_staff=nemo" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://erp.dstadvertising.com/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"voluptas","new_password":"quo"}'
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/profit-loss-report?location_id=quis&start_date=2018-06-25&end_date=2018-06-25&user_id=nam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://erp.dstadvertising.com/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://erp.dstadvertising.com/public/connector/api/notifications"
);
